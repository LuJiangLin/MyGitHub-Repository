...
<link rel="Bookmark" href="${ip}/temp/favicon.ico" >
<link rel="Shortcut Icon" href="${ip}/temp/favicon.ico" />

<title>SuperAdmin</title>
<%@ include file="View/include/header.jsp"%>
<meta name="keywords" content="鲁大师后台管理系统 v3.1,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
<meta name="description" content="鲁大师后台管理系统 v3.1，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">鲁大师后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/user/searchUser" data-title="会员列表" href="javascript:;">会员列表</a></li>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a data-href="${pageContext.request.contextPath}/system/fingDataDictionary" data-title="数据字典" href="javascript:void(0)">数据字典</a></li>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ip}/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
