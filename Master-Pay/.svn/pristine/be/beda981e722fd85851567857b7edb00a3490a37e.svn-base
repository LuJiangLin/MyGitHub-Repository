...
import com.fm.pay.ext.kit.StrKit;
...
public final class HttpUtils {
    ...
    private static class HttpKitDelegate implements HttpDelegate {
        ...
        @Override
        public String get(String url) {
            return com.fm.pay.ext.kit.HttpKit.get(url);
        }

        @Override
        public String get(String url, Map<String, String> queryParas) {
            return com.fm.pay.ext.kit.HttpKit.get(url, queryParas);
        }

        @Override
        public String post(String url, String data) {
            return com.fm.pay.ext.kit.HttpKit.post(url, data);
        }
        @Override
		public String post(String url, Map<String, String> queryParas) {
			return com.fm.pay.ext.kit.HttpKit.post(url, queryParas, "null");
		}
